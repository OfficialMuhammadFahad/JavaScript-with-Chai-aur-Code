...
// console.log(arr.push(5));//Add element on the last index
// console.log(arr.pop()); //Remove element on the last index
// console.log(arr.unshift(8)); //Add element on the first index
// console.log(arr.shift(8)); //Romove element on the first index
...
// console.log(arr.indexOf(6));//Find the index of element and if the element is not present always give the -1 response
// console.log(arr);
...
console.log(arr2);
let newArr3 = arr2.splice(3, 6);//Remove the required elements and modify the original array
console.log(arr2);
