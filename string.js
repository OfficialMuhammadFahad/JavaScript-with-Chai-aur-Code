...
console.log(fullName.slice(0, 5)); //Find index of element with positions and also take negative values
...
console.log(randomUrl.includes("Muhammad"));//Check the element in url
console.log(randomUrl.includes("Fawad"));//Check the element in url
